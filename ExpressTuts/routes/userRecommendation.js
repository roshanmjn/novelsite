...
//THIS ROUTER IS FOR TEST AND REAL ROUTER STARTS AFTER THIS ONE.
...
//STARTS HERE
//1.SEND USER THE DATA SET OF ALL USERS
...
//COLLABRATIVE FILTERING ALGORITHM
router.post("/recommendation-algorithm", (req, res) => {
  ...
  //FUNCTION TO GET THE DISTANCE BETWEEN ROW USERS
  ...
  //FUNCTION TO GET TH RECOMMENDATION OF A CERTAIN USER
...
router.post("/recommendation-algorithmRating", (req, res) => {
  dataset = req.body.data;
  user = req.body.user1;
  ...
  //FUNCTION TO GET TH RECOMMENDATION OF A CERTAIN USER
  const getAverageRating = (dataset, person) => {
    var total = {};
    var simSums = {};
    var similarSums = {};
    var ranks = {};
  ...
  // res.send(getAverageRating(dataset, user));
  console.log(getAverageRating(dataset, user));
});
