...
(1, 'A Frozen Player Returns, and a Player Who Can\'t Level Up!', 'Hi everyone, continuing with our series of rapid releases, we have two more Korean titles that are ready to be released, starting off with thirty chapters each!  By coincidence, both of the MC\'s are... players.  The next batch shall be Chinese series, so for those who are waiting for that, more news will be coming soon!', '\'2022-04-28 02:28:50\'', 0),
(2, 'Player Who Can\'t Level Up: ', 'Gi-Gyu is an upstanding young man who had been suffering from near-poverty due to unfortunate family situations. Even from a very young age, he worked multiple jobs to support his young sister and his ill mother.', '\'2022-04-28 02:33:20\'', 0);
...
(39, 'The Declaration of Independence of the United States of America', 'Fantasy', 'Jefferson, Thomas', 66, 'https://www.gutenberg.org/ebooks/1.txt.utf-8', 'hiatus', 0, '2022-05-11 23:53:35', '', 'https://www.gutenberg.org/cache/epub/1/pg1.cover.small.jpg'),
(40, 'The United States Bill of Rights', 'Wuxia', 'United States', 25, 'https://www.gutenberg.org/ebooks/2.txt.utf-8', 'ongoing', 0, '2022-05-11 23:53:35', '', 'https://www.gutenberg.org/cache/epub/2/pg2.cover.small.jpg'),
(41, 'John F. Kennedy\'s Inaugural Address', 'Fantasy', 'Kennedy, John F. (John Fitzgerald)', 24, 'https://www.gutenberg.org/ebooks/3.txt.utf-8', 'completed', 0, '2022-05-11 23:53:36', '', 'https://www.gutenberg.org/cache/epub/3/pg3.cover.medium.jpg'),
...
(46, 'asd', 'asd', 'asdfg', 'asd@asd.com', 'male', 'npl', 0, '', '2022-04-29 05:48:36');
...
CREATE TABLE `tbl_user_log` (
  ...
  `currently_reading` varchar(2048) DEFAULT NULL,
  `bookmarks` varchar(5000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `tbl_users`
  MODIFY `id` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
